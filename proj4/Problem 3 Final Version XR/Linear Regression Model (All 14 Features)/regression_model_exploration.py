...
def train_model(reader,hashtag):
    x1=[]
    x2=[]
    x3=[]
    x4=[]
    ...
    # use all 14 features to see which feature has a strong relation with the tweet number.
    ...
    i=0
    feature_list=[x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14]
    feature_name_list=['tweet','retweet','follower','max_follower','time','acceleration','favorite','statuses','ranking','influential','matching','momentum','usermetion','emotion']
...
if __name__ == '__main__':
    ...
    for hashtag in hashtag_list:
        reader = csv.reader(file("Processed_Data_"+hashtag+".csv", 'rb'))
        train_model(reader,hashtag)